(function () {
    ...
    angular
        ...
        .factory('Installment', ['$resource', '$location', function ($resource, $location) {
            return $resource(
                            '/bpproperty/api/land/:landId/buyDetail/:buyDetailId/installmentsRecord/:installmentId',
                            {
                                landId: '@landId',
                            ...
                            {
                                'update': {method: 'PUT'},
                                'query': {method: 'GET', params: {landId: '@landId', page: '@page', length: '@length'}, isArray:true}
                            });
        }]);
